...
async function sendVerificationEmail(account, origin) {
    ...
    if (origin) {
        ...
        message = `<p>Use the below token to verify your email address with the /accounts/verify-email API route:</p>
...
async function sendAlreadyRegisteredEmail(email, origin) {
    let message;
    if (origin) {
        message = `<p>If you don't know your password, you can reset it via the <a href="${origin}/forgot-password">forgot password</a> page.</p>`;
    } else {
        message = `<p>If you don't know your password, you can reset it via the /accounts/forgot-password API route.</p>`;
    }
...
async function sendPasswordResetEmail(account, origin) {
    ...
    if (origin) {
        ...
        message = `<p>Use the below token to reset your password with the /accounts/reset-password API route:</p>
